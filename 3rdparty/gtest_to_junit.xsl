...
-->
<!--
Source: https://github.com/jakoch/hikogui/blob/01ea847b5e2ec88def38f0e190741ac6671052b6/.github/gtest_to_junit.xsl
-->
    ...
    <xsl:template match="//testsuites">
        <testsuites>
            <xsl:attribute name="time">
                <xsl:value-of select="sum(//testsuites/testsuite/@time)"/>
            </xsl:attribute>
            <xsl:apply-templates/>
        </testsuites>
    </xsl:template>
